...
const BlogTitles = () => {
    ...
    const onSubmitHandler=async(e)=>{
      ...
      try {
        ...
        const prompt=`Generate top 5 titles  for the keyword ${input} in the category ${selectedCategory}`
  ...
  return (
    ...
    gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        bg-linear-to-r from-[#C341F6] to-[#8E37EB] text-white px-4
        py-2 mt-6 text-sm rounded-lg cursor-pointer'>
         {
          loading?<span className='w-4 h-4 my-1 rounded-full border-2 border-t-transport animate-spin'>

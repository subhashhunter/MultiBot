  ...
  return (
    ...
    gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e)=>setInput(e.target.files[0])}  type='file' accept='application/pdf' className='w-full text-gray-500 p-2 px-3 mt-2 outline-none text-sm 
      ...
      <p className='text-xs text-gray-500 font-light mt-1'>Support PDF Resume only</p>
        ...
        bg-linear-to-r from-[#00DA83] to-[#009BB3] text-white px-4

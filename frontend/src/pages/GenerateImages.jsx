...
const GenerateImages = () => {
      const imageStyle=['Realisitc','Ghibli style','Anime style','Cartoon style',
        'Fanstasy style','Realistic style','3D style','Portrait style'
      ]
   ...
   <div className='h-full overflow-y-scroll p-6 flex items-start flex-start
    gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
         ...
         <div className='my-6 flex items-center gap-2'>
          <label className='relative cursor-pointer'>
            ...
            <p className='text-sm pt-2'> Make this image Public</p>
          </label>
        ...
        bg-linear-to-r from-[#00AD25] to-[#04FF50] text-white px-4

...
const Footer = () => {
  return (
    ...
    <footer className="px-6 bg-black text-white md:px-16 lg:px-24 xl:px-32 pt-8 w-full mt-20 ">
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                Experience The power of AI.<br/>Transform your
                content creation with our suite of premimu AI tools.Write articles,
                generate images ,and enhance your workflow.
            </p>
        </div>
        <div className="flex-1 flex  text-white items-start md:justify-end gap-20">
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        <input className="border border-gray-500/30 placeholder-gray-500 focus:ring-2 ring-indigo-600 outline-none w-full
                         max-w-64 h-9 rounded px-2" type="email" placeholder="Enter your email"/>
                        <button className="bg-indigo-600  cursor-pointer w-24 h-9 text-white rounded">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
